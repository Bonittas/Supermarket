...
const Snacks  = ({ cartItems, setCartItems }) => {
  ...
  const filteredProducts = categories[3].products.filter((product) =>
    ...
    <>
      ...
      <div className="container mx-auto px-3">
        <div className="flex flex-col md:flex-row">
          ...
          <div className=" p-4">
            <h2 className="text-2xl font-bold mb-4">Snacks and Deserts</h2>
