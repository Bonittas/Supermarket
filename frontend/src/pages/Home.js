...
const Home = () => {
  ...
  return (
    <>
      ...
      <section id="Categories" className="container bg-white max-h-screen py-2">
        <div className="flex flex-col md:flex-row space-y-0 md:space-y-0">
          ...
          <div className="w-full mx-auto md:w-3/4 max-h-screen">
      ...
      <section
        id="featuredProduct"
        className="border border-t shadow-sm py-2 px-6 max-h-screen"
      >
