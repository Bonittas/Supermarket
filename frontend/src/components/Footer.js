...
function Footer() {
  return (
    <footer className="bg-green-500 pt-12 pb-6 px-8">
        ...
        <div className="flex flex-wrap">
          <div className="w-full md:w-1/2 lg:w-1/4 mb-6 md:mb-0">
            ...
            <div className="flex items-start mb-2">
              <FontAwesomeIcon
                icon={faMapMarkerAlt}
                className="text-white text-xl mr-2 mt-1"
              />
              <p className="text-white">
                Ethiopia, Addis Ababa, Amist Kilo, 1000
              </p>
            </div>
            <div className="flex items-start mb-2">
              <FontAwesomeIcon
                icon={faPhone}
                className="text-white mr-2 text-xl mt-1"
              />
            ...
            <div className="flex items-start mb-2">
              <FontAwesomeIcon
                icon={faEnvelope}
                className="text-white text-2xl mr-2 mt-1"
              />
      ...
      <div className="py-2">
        <div className="container mx-auto px-4">
          <p className="text-center text-white text-sm">
            &copy; {new Date().getFullYear()} iShop Supermarket. All rights
            reserved.
          </p>
        </div>
      </div>
